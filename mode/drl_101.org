...
#+CAPTION[混合策略]: 混合策略
#+NAME: 混合策略
#+ATTR_HTML: :alt  :title 混合策略 width 800px  :align center
    ...
    node1 [shape=none, margin=0, fontname="LXGW WenKai Mono", label=<
        <TABLE BORDER="0" CELLBORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="400" HEIGHT="300">
            ...
            <TR>
                ...
                <TD WIDTH="100" HEIGHT="100">p<sup>A</sup></TD>
            </TR>
            <TR>
                <TD WIDTH="100" HEIGHT="100" BGCOLOR="None">撤退</TD>
                ...
                <TD WIDTH="100" HEIGHT="100">1-p<sup>A</sup></TD>
            </TR>
        </TABLE>
    >];
}
...
#+ATTR_HTML: :alt  :title 混合策略 width 800px  :align center
#+attr_org: :width 600px
#+begin_src dot :file img/drl101/mixed1.png
digraph G {
    node1 [shape=none, margin=0, fontname="LXGW WenKai Mono", label=<
...
#+REVEAL_HTML: <div class="gridded_frame_with_columns">
     #+REVEAL_HTML: <div class="one_of_2_columns">
        #+ATTR_REVEAL: :frag (appear)
        #+ATTR_HTML: :alt  :title Optimal Control :width 600px  :align center
        #+attr_org: :width 400px :align left
        #+CAPTION: 最优控制
        [[./img/drl101/hiking.jpg]]
     #+REVEAL_HTML: </div>
     #+REVEAL_HTML: <div class="one_of_2_columns">
        #+ATTR_REVEAL: :frag (appear)
        #+ATTR_HTML: :alt  :title Reinforcement Learning :width 600px  :align center
        #+attr_org: :width 400px :align left
        #+CAPTION: 强化学习
        [[./img/drl101/surfing.jpg]]
     #+REVEAL_HTML: </div>
#+REVEAL_HTML: </div>
