...
@@html:<div class="r-stack">@@
        @@html:<img class="fragment fade-out data-fragment-index="0" src="img/_generated/dominated_fight.png" />@@
        @@html:<img class="fragment current-visible" data-fragment-index="0" src="img/_generated/dominated_fight0.png" />@@
        @@html:<img class="fragment current-visible" data-fragment-index="1" src="img/_generated/dominated_fight1.png" />@@
        @@html:<img class="fragment" data-fragment-index="2" src="img/_generated/dominated_fight2.png" />@@
@@html:</div>@@
...
#+begin_src dot :file img/_generated/dominated_fight.png :cache yes
digraph G {
...
#+attr_org: :width 600px
#+begin_src dot :file img/_generated/dominated_fight2.png :cache yes
digraph G {
    node1 [shape=none, margin=0, fontname="LXGW WenKai Mono", label=<
        <TABLE BORDER="0" CELLBORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="300" HEIGHT="300">
            <TR>
            ...
            <TR>
                <TD WIDTH="100" HEIGHT="100" BGCOLOR="None"><u><font color="darkgreen">攻击</font></u></TD>
...
#+end_src
#+RESULTS[668b24678cb475e8214f0bb6765d0ead1ccc0e54]: 对决2
...
@@html:<div class="r-stack">@@
        @@html:<img class="fragment fade-out data-fragment-index="0" src="img/_generated/ne.png" />@@
        @@html:<img class="fragment current-visible" data-fragment-index="0" src="img/_generated/ne1.png" />@@
        @@html:<img class="fragment current-visible" data-fragment-index="1" src="img/_generated/ne2.png" />@@
        @@html:<img class="fragment" data-fragment-index="2" src="img/_generated/ne3.png" />@@
@@html:</div>@@
...
#+attr_org: :width 600px
#+begin_src dot :file img/_generated/ne.png :cache yes
digraph G {
    node1 [shape=none, margin=0, fontname="LXGW WenKai Mono", label=<
        <TABLE BORDER="0" CELLBORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="300" HEIGHT="300">
            <TR>
...
#+attr_org: :width 600px
#+begin_src dot :file img/_generated/ne1.png :cache yes
digraph G {
    node1 [shape=none, margin=0, fontname="LXGW WenKai Mono", label=<
        <TABLE BORDER="0" CELLBORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="300" HEIGHT="300">
            <TR>
...
#+attr_org: :width 600px
#+begin_src dot :file img/_generated/ne2.png :cache yes
digraph G {
    node1 [shape=none, margin=0, fontname="LXGW WenKai Mono", label=<
        <TABLE BORDER="0" CELLBORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="300" HEIGHT="300">
            <TR>
...
#+attr_org: :width 600px
#+begin_src dot :file img/_generated/ne3.png :cache yes
digraph G {
    node1 [shape=none, margin=0, fontname="LXGW WenKai Mono", label=<
        <TABLE BORDER="0" CELLBORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="300" HEIGHT="300">
            <TR>
...
#+RESULTS[10527cb8662657846bedfb060763240722809c33]: 势均力敌3
...
#+begin_src dot :file img/_generated/mixed.png :cache yes
digraph G {
    node1 [shape=none, margin=0, fontname="LXGW WenKai Mono", label=<
        <TABLE BORDER="0" CELLBORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="200" HEIGHT="150">
            ...
            <TR>
                ...
                <TD WIDTH="50" HEIGHT="50" BGCOLOR="lightgreen" BORDER="1"><u>2</u>,<u><FONT COLOR="blue">0</FONT></u></TD>
                <TD WIDTH="50" HEIGHT="50">p<sup>A</sup></TD>
            </TR>
            <TR>
                <TD WIDTH="50" HEIGHT="50" BGCOLOR="None">撤退</TD>
                <TD WIDTH="50" HEIGHT="50" BGCOLOR="lightgreen" BORDER="1"><u>0</u>,<u><FONT COLOR="red">2</FONT></u></TD>
...
#+RESULTS[bc3db3ba7ebd0d93d65d4b9ff5feb0ae98494047]: 混合策略
...
#+REVEAL_HTML: <div class="gridded_frame_with_columns">
     #+REVEAL_HTML: <div class="one_of_2_columns">
        @@html:<div class="r-stack">@@
         @@html:<img class="fragment fade-out data-fragment-index="0" src="img/_generated/mixed.png" />@@
         @@html:<img class="fragment current-visible" data-fragment-index="0" src="img/_generated/flat_tree.png" />@@
         @@html:<img class="fragment" data-fragment-index="1" src="img/_generated/flat_tree2.png" />@@
        @@html:</div>@@
     #+REVEAL_HTML: </div>
     #+REVEAL_HTML: <div class="one_of_2_columns">
        @@html:<div class="r-stack">@@
         @@html:<img class="fragment fade-out data-fragment-index="2" src="img/_generated/tree.png" />@@
         @@html:<img class="fragment" data-fragment-index="2" src="img/_generated/flat_tree3.png" />@@
        @@html:</div>@@
     #+REVEAL_HTML: </div>
#+REVEAL_HTML: </div>
...
#+begin_src dot :file img/_generated/tree.png :cache yes
digraph G {
    rankdir=LR;
...
#+REVEAL_HTML: <div class="gridded_frame_with_columns">
     ...
     #+REVEAL_HTML: <div class="one_of_2_columns">
        ...
        #+attr_org: :width 300px :align left
        #+begin_src dot :file img/_generated/flat_tree.png :cache yes
        digraph G {
            rankdir=LR;
            {
                node [group=top]
...
#+REVEAL_HTML: <div class="gridded_frame_with_columns">
     ...
     #+REVEAL_HTML: <div class="one_of_2_columns">
        ...
        #+attr_org: :width 300px :align left
        #+begin_src dot :file img/_generated/flat_tree2.png :cache yes
        digraph G {
            rankdir=LR;
            {
                node [group=top]
...
#+REVEAL_HTML: <div class="gridded_frame_with_columns">
     #+REVEAL_HTML: <div class="one_of_2_columns">
        ...
        #+attr_org: :width 300px :align left
        #+begin_src dot :file img/_generated/flat_tree3.png :cache yes
        digraph G {
            rankdir=LR;
            {
                node [group=top]
...
@@html:<div class="r-stack">@@
        @@html:<img class="fragment fade-out data-fragment-index="0" src="img/_generated/tree21.png" />@@
        @@html:<img class="fragment current-visible" data-fragment-index="0" src="img/_generated/tree3.png" />@@
        @@html:<img class="fragment" data-fragment-index="1" src="img/_generated/tree4.png" />@@
@@html:</div>@@
...
#+attr_org: :width 600px
#+begin_src dot :file img/_generated/tree21.png :cache yes
digraph G {
    rankdir=LR;
    {
        node [group=top]
...
#+RESULTS[377df38af724a26ddc809cac429aec75c2cf49fd]: 决策树21
...
#+attr_org: :width 600px
#+begin_src dot :file img/_generated/tree3.png :cache yes
digraph G {
    rankdir=LR;
    {
        node [group=top]
...
#+RESULTS[04668f2330bbf386889f4e00b42408a89b968580]: 决策树3
...
#+attr_org: :width 600px
#+begin_src dot :file img/_generated/tree4.png :cache yes
digraph G {
    rankdir=LR;
    {
        node [group=top]
...
#+RESULTS[a7522d9ca5d07bac1bbf8d1a25f08fc7ee700b24]: 决策树4
...
@@html:<div class="r-stack">@@
        @@html:<img class="fragment fade-out data-fragment-index="0" src="img/_generated/tree_sample0.png" />@@
        @@html:<img class="fragment current-visible" data-fragment-index="0" src="img/_generated/tree_sample.png" />@@
        @@html:<img class="fragment current-visible" data-fragment-index="1" src="img/_generated/tree_sample1.png" />@@
        @@html:<img class="fragment current-visible" data-fragment-index="2" src="img/_generated/tree_sample2.png" />@@
        @@html:<img class="fragment" data-fragment-index="3" src="img/_generated/tree_sample3.png" />@@
@@html:</div>@@
...
#+NAME: 决策树采样0
#+attr_org: :width 600px :align left
#+begin_src dot :file img/_generated/tree_sample0.png :cache yes
digraph G {
    rankdir=LR;
    {
        node [group=top]
...
#+NAME: 决策树采样
#+attr_org: :width 600px
#+begin_src dot :file img/_generated/tree_sample.png :cache yes
digraph G {
    rankdir=LR;
    {
        node [group=top]
...
:END:
#+ATTR_REVEAL: :frag (appear)
#+ATTR_HTML: :alt  :title 决策树采样3 width 800px  :align center
#+CAPTION[决策树采样3]: 决策树采样3
#+NAME: 决策树采样3
#+attr_org: :width 600px
#+begin_src dot :file img/_generated/tree_sample3.png :cache yes
digraph G {
    rankdir=LR;
    {
        node [group=top]
    ...
    B21 -> A31[label="F(4)"]
    P32[label=<<FONT COLOR="coral">-c</FONT>+v,<FONT COLOR="coral">-c</FONT>+0>,shape=rect,color=none,color="lime"]
    P31[label=<<FONT COLOR="coral">-c</FONT>+0,<FONT COLOR="coral">-c</FONT>+v>,shape=rect,color=none]
    P33[label=<<FONT COLOR="coral">-c</FONT>+0,<FONT COLOR="coral">-c</FONT>+0>,shape=rect]
    A31 -> future[style="dashed"]
    B21 -> P32[label="Q(4)",color="lime"]
...
#+RESULTS[cfaeaa76521141ac703ea390642fb21564ac4759]: 决策树采样3
[[file:img/_generated/tree_sample3.png]]
...
#+NAME: 决策树采样1
#+attr_org: :width 600px
#+begin_src dot :file img/_generated/tree_sample1.png :cache yes
digraph G {
    rankdir=LR;
    {
        node [group=top]
...
#+NAME: 决策树采样2
#+attr_org: :width 600px
#+begin_src dot :file img/_generated/tree_sample2.png :cache yes
digraph G {
    rankdir=LR;
    {
        node [group=top]
...
[[./img/_generated/tree_sample1.png]]
