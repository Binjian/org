...
\maketitle
\section*{Talk Map}
\label{sec:org402faf2}

\begin{frame}[label={sec:org46fcbb5}]{Agenda}
\begin{center}
\begin{tabular}{rll}
Part & Topic & Time\\
\hline
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgc4f024d}]{Main claim}
...
\end{frame}
\section*{Motivation}
\label{sec:org04d9919}

\begin{frame}[label={sec:org59706fd}]{Why energy optimization is still hard}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga51df50}]{Gap in existing DRL eco-driving work}
\begin{itemize}
...
\label{sec:orge4d75a7}

\begin{frame}[label={sec:orgb86630d}]{Driver-in-the-loop control}
...
\]
\end{frame}
\begin{frame}[label={sec:org5571e8e}]{Markov decision process}
\begin{center}
\begin{tabular}{ll}
...
electric work.
\end{frame}
\begin{frame}[label={sec:org68af750}]{Action: modify the pedal map}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org42ffe06}]{Why this action is practical}
\begin{itemize}
...
\label{sec:org1f0ea5a}

\begin{frame}[label={sec:org4c9d51f}]{DDPG training loop}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgbebcfd5}]{Network role separation}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgea0065e}]{Data record and replay buffer}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgedb2291}]{Deployment dataflow}
\begin{columns}
...
\end{frame}
\section*{Experiments}
\label{sec:org79c2750}

\begin{frame}[label={sec:orgc19aa39}]{Proving-ground training setup}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org64d093b}]{Driving-style monitoring}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org423dab6}]{Proving-ground result}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org78d713c}]{Public-road route 1}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgcf340a2}]{Public-road route 1 result}
\begin{columns}
\begin{column}{0.52\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org95e7a5b}]{Route 1 driving-style drift}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org642fd68}]{Transfer to route 2}
\begin{columns}
\begin{column}{0.52\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd2036c4}]{Multimodal road scenarios}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2474d82}]{What the experiments show}
\begin{itemize}
...
\end{frame}
\section*{Discussion}
\label{sec:orgce6dbb7}

\begin{frame}[label={sec:org20323bc}]{Deployment constraints}
...
\end{frame}
\begin{frame}[label={sec:org21964d6}]{Limitations and future work}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org72bbf1e}]{Takeaways}
\begin{enumerate}
