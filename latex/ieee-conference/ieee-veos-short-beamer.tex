...
\maketitle
\section*{Talk Map}
\label{sec:org2d917f1}

\begin{frame}[label={sec:org8201221}]{Thirty-minute structure}
\begin{center}
\begin{tabular}{rll}
Part & Topic & Time\\
\hline
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgbc1a835}]{Main claim}
...
\end{frame}
\section*{Motivation}
\label{sec:orgf2ec68b}

\begin{frame}[label={sec:org9dc4b69}]{Why energy optimization is still hard}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org3735b46}]{Gap in existing DRL eco-driving work}
\begin{itemize}
...
\label{sec:org2ceaf4b}

\begin{frame}[label={sec:orgf6cedb0}]{Driver-in-the-loop control}
...
\]
\end{frame}
\begin{frame}[label={sec:org4957e06}]{Markov decision process}
\begin{center}
\begin{tabular}{ll}
...
electric work.
\end{frame}
\begin{frame}[label={sec:org5b60792}]{Action: modify the pedal map}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge45c463}]{Why this action is practical}
\begin{itemize}
...
\label{sec:org1341b02}

\begin{frame}[label={sec:orge567191}]{DDPG training loop}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org0c1d403}]{Network role separation}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org4f65fc0}]{Data record and replay buffer}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org0784da7}]{Deployment dataflow}
\begin{columns}
...
\end{frame}
\section*{Experiments}
\label{sec:org295db98}

\begin{frame}[label={sec:orgf2f59d7}]{Proving-ground training setup}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org415915f}]{Driving-style monitoring}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd534836}]{Proving-ground result}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgb554e99}]{Public-road route 1}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org025bb6f}]{Public-road route 1 result}
\begin{columns}
\begin{column}{0.52\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgced2074}]{Route 1 driving-style drift}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org141054c}]{Transfer to route 2}
\begin{columns}
\begin{column}{0.52\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0275cb4}]{Multimodal road scenarios}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org5e0556a}]{What the experiments show}
\begin{itemize}
...
\end{frame}
\section*{Discussion}
\label{sec:org5f30d7a}

\begin{frame}[label={sec:org4d973ac}]{Deployment constraints}
...
\end{frame}
\begin{frame}[label={sec:org2978c63}]{Limitations and future work}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgda8fca8}]{Takeaways}
\begin{enumerate}
