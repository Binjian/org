...
#+begin_src mermaid :file ./img/data_flow_cloud.svg
graph TB
...
#+begin_src mermaid :file ./img/data_flow_kvaser.svg
graph TB
  subgraph vehicle ["Vehicle"]
    %% line 0
